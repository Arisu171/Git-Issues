...
import { ActionFeedback, ErrorBox, PageHead, Pager, Refreshing, RequiredMark, Select, SeverityBadge, SlaBadge, StatusBadge, SubmitButton, Toggle } from '@/components/ui';
  ...
  return (
    <>
      ...
      {creating && (
        <div className="card">
          ...
          <p className="card-hint">
            {tr('Sự cố luôn được tạo ở trạng thái')} <strong>{tr('Đang điều tra')}</strong> {tr('và người ghi nhận là tài khoản bạn đang đăng nhập. Hai giá trị này không sửa được ở biểu mẫu.')}
          </p>
      ...
      <div className="list-section">
        ...
        {load.isProcessing && !data && <div className="empty">{tr('Đang tải danh sách sự cố…')}</div>}
